        ...
        *,
        ...
        @media (prefers-color-scheme:dark) {
            .dark\:bg-gray-800 {
                ...
                background-color: rgba(45, 55, 72, var(--bg-opacity)) background-image: url('bg.jpg');
            }
        ...
        <div
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    ...
                    <h1 class="text-danger"> Deni Tri Muslimin S.Kom</h1>
                ...
                <div class="justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-center">
                        <div class="items-center">
                            ...
                            <h2><a href="{{ url('/home') }}" style="margin-right: 1rem; margin-left:1rem;"
                                    class="text-primary">
                                    CRUD
                                </a>
                            </h2>
